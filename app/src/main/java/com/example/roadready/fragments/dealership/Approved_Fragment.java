...
import com.example.roadready.databinding.FragmentApprovedBinding;
...
public class Approved_Fragment extends Fragment {
    ...
    private FragmentApprovedBinding binding; // use View binding to avoid using too much findViewById
