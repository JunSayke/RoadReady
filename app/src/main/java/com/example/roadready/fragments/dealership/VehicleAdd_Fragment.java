...
public class VehicleAdd_Fragment extends Fragment {
		private final String TAG = "VehicleAdd_Activity"; // declare TAG for each class for debugging purposes using Log.d()
		private FragmentVehicleAddBinding binding; // use View binding to avoid using too much findViewById

	public View onCreateView(@NonNull LayoutInflater inflater,
							 ViewGroup container, Bundle savedInstanceState) {

		binding = FragmentVehicleAddBinding.inflate(inflater, container, false);
