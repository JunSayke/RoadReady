...
public class CashPaymentForm_Fragment extends Fragment {
    private static final String TAG = "CashPaymentForm_Activity"; // declare TAG for each class for debugging purposes using Log.d()
    private FragmentCashPaymentFormBinding binding; // use View binding to avoid using too much findViewById
