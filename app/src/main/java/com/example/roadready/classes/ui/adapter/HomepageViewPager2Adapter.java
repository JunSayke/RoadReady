...
import com.example.roadready.fragments.buyer.mainnav.HomeContainer_Fragment;
...
public class HomepageViewPager2Adapter extends FragmentStateAdapter {
    ...
    public HomepageViewPager2Adapter(@NonNull FragmentActivity fragmentActivity) throws Exception {
